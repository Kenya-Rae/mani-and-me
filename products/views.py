...
from .forms import (
    ...
    ProductImageForm, InventoryForm, InventoryUpdateForm
)
    ...
    if request.method == 'POST':
        ...
        if product_form.is_valid():
            ...
            if product.has_sizes:
                ...
                messages.success(
                    request,
                    'Successfully added product with sizes and inventory!'
                    )
            else:
...
def manage_inventory(request):
    ...
    return render(
        request, 'products/manage_inventory.html',
        {'products': products}
        )
...
def update_inventory(request, product_id):
        ...
        if form.is_valid():
            ...
            if existing_inventory:
                ...
                if quantity < 0:
                    ...
                    messages.success(
                        request, f"Updated stock for size {size}."
                        )
            else:
    ...
    return render(
        request, 'products/update_inventory.html',
        {'form': form, 'product': product}
        )
